c===========================================================================
c     routines from minpack
c     argonne national laboratory. minpack project. march 1980.
c     burton s. garbow, kenneth e. hillstrom, jorge j. more
c     several separate files are merged in one file:
c chkder.f, dogleg.f, dpmpar.f, enorm.f, fdjac2.f, lmder.f, lmdif.f,
c lmpar.f, qform.f, qrfac.f, qrsolv.f, r1mpyq.f, r1updt.f, rwupdt.f
c see file LICENSE or back of this file, for copyright
c===========================================================================
